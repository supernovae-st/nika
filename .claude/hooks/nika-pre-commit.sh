...
# Nika workspace (6-crate structure)
NIKA_DIR="$PROJECT_DIR"
SPEC_FILE="$NIKA_DIR/spec/SPEC.md"
ACTION_RS="$NIKA_DIR/crates/nika-core/src/ast/action.rs"
...
code_errors=$(grep -c "NIKA-[0-9]*" "$NIKA_DIR/crates/nika-core/src/error.rs" 2>/dev/null || echo "0")
