...
**Current Version**: v0.11.0 — EditHistory wired + Thinking display + McpRetry emission + Home validation
**Tests**: 2,876 passing | **Roadmap**: `ROADMAP.md` | **Changelog**: `CHANGELOG.md`
