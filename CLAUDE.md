...
**Current Version**: v0.12.0 — ARMADA CI (10 stations) + 6-Views TUI + TaskBox widgets
**Tests**: 2,997 passing | **Roadmap**: `ROADMAP.md` | **Changelog**: `CHANGELOG.md`
