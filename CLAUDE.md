...
This project is indexed by GitNexus as **engine** (2774 symbols, 4412 relationships, 87 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/engine/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/engine/context` | Codebase overview, check index freshness |
| `gitnexus://repo/engine/clusters` | All functional areas |
| `gitnexus://repo/engine/processes` | All execution flows |
| `gitnexus://repo/engine/process/{name}` | Step-by-step execution trace |
