...
> **v0.90.0 is the first public, brew-installable Diamond release** (2026-06-21
> · `brew install supernovae-st/nika/nika`). 39/42 crates admitted, the wip
> array is empty. It is **release-candidate grade** on the path to the **1.0.0**
> public launch (the 7 shadow zones gate 1.0 · D-2026-06-20-N1); the remaining
> crates land additively across the 1.x minors.
