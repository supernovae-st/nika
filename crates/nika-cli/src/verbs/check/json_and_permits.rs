...
//! JSON, native-strict, permits-infer, and identity pins — split from
//! `tests.rs` under the 1500-line file law.

use super::tests::{checked_output, checked_text, parse_wf};
use super::*;
