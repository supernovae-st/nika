...
use nika_core::ast::{AgentParams, DecomposeSpec, DecomposeStrategy};
use nika_core::binding::UseEntry;
use nika_core::event::EventKind;
use serde_json::json;
use std::sync::Arc;
...
fn test_phase1_agent_turn_metadata_has_thinking_field() {
    ...
    use nika_core::event::AgentTurnMetadata;
