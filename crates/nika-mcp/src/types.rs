...
//! - [`McpErrorCode`]: JSON-RPC error codes (v0.5.3) - re-exported from nika-core

use rustc_hash::FxHashMap;

use serde::{Deserialize, Serialize};

// Re-export McpErrorCode from nika-core (where it's defined for error.rs)
pub use nika_core::mcp_types::McpErrorCode;
