...
mod tests {
    use super::*;
    use nika_core::ast::{ExecParams, Flow, FlowEndpoint, Task, TaskAction};
    use std::sync::Arc;
    ...
    fn test_runner_quiet_mode() {
        ...
        let event_log = nika_core::event::EventLog::new();
