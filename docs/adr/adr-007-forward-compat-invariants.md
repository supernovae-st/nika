...
supersedes: []
superseded_by: []
related: ["ADR-002", "ADR-005", "ADR-006", "ADR-008", "ADR-010", "ADR-012", "ADR-015", "ADR-016", "ADR-019", "ADR-020", "ADR-028", "ADR-033", "ADR-034", "ADR-039", "ADR-040", "ADR-027"]
...
- `crates/nika-kernel-ai/src/provider.rs` lines 196–239 — `InferRequest` with `memory: Option<MemoryDirective>`, `new()` constructor, full field list
- `crates/nika-kernel-ai/src/provider.rs` lines 291–312 — `InferResponse` with `memory_frames: Vec<MemoryFrameRef>`
- `crates/nika-kernel-ai/src/memory.rs` lines 272–305 — `MemoryStore` + `EmbeddingProvider` trait declarations (Cortex hooks)
- `crates/nika-kernel-runtime/src/tool_executor.rs` — `ToolExecutor` trait (agent-v2 hook)
