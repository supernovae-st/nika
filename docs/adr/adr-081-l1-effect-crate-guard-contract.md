...
supersedes: []
superseded_by: []
related: ["ADR-003", "ADR-005", "ADR-014", "ADR-016", "ADR-017"]
requires: ["ADR-003"]
enables: ["nika-screen M2.1", "nika-ocr M2.2", "nika-a11y M2.3", "nika-input M2.4", "nika-browser M2.5", "nika-vision-local M2.6"]
amends: []
fci: ["FCI-2 cancel-safety", "FCI-3 #[non_exhaustive]", "FCI-5 #[trait_variant::make] async"]
inv: ["INV-zero-unwrap", "INV-iso-test", "INV-pattern-1-atomic"]
