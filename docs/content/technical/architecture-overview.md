...
- **NikaMcpConfig**: Reads `~/.nika/mcp.json` for global MCP server definitions.
...
CLI command implementations (8K lines): course, provider, mcp, model, pkg, media, trace, config, schema, showcase, setup, workflow.
