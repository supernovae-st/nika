...
~20374 LOC src (live anchor · total incl. tests — ~10,123 prod per the
ratchet's `scripts/ci/check-crate-size.sh` scope) · largest file ~1,315
LOC · ~495 unit + ~32 integration tests (the conformance harness at
