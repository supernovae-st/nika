...
~24285 LOC src (live anchor · total incl. tests — ~12,167 prod per the
ratchet's `scripts/ci/check-crate-size.sh` scope) · largest file ~1,404
LOC · ~557 unit + ~36 integration tests (the conformance harness at
