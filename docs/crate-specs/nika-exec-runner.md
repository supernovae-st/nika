...
| LOC (live) | ~4501 LOC src (live · `scripts/crate-metrics.sh nika-exec-runner`) |
...
| 3 IMPL | ✅ | ~4501 LOC src (live · `scripts/crate-metrics.sh nika-exec-runner`) · zero unwrap/expect in src |
