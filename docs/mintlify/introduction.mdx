...
<Note>
  ...
  11,383 src LOC · 385 tests · 0 clippy warnings · 0 unwraps in `src/`.
  Each crate passes [12 gates](/concepts/architecture#build-model) before joining the workspace.
  v0.90 marks the complete architecture. [Build status →](/reference/status)
</Note>
