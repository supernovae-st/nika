...
<Note>
  **Current status (April 2026):** 5 of 40 crates admitted.
  10,434 LOC · 369 tests · 0 `.unwrap()` in `src/` · 0 clippy warnings.
  See [CHANGELOG](https://nika.sh/changelog) for weekly progress.
</Note>
...
**Total admitted:** 10,434 LOC · 369 tests · 100% mutation tested
