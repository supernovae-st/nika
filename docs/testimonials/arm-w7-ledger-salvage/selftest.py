...
def fixture_artifact_durability(guard: dict[str, Any]) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    validator["block_guard_signals"](guard)
    return artifacts, validator["fsync_bound_artifacts"](output, artifacts)
...
def completed_nonzero_process(guard: dict[str, Any]) -> tuple[int, dict[str, Any], int]:
    ...
    validator["settle_raw_receipt"](
        guard, minimal_raw_receipt(artifacts, durability)
    )
    return process
...
def hangup_after_receipt(guard: dict[str, Any]) -> None:
    ...
    validator["settle_raw_receipt"](
        guard,
        minimal_raw_receipt(artifacts, durability),
...
validator["require"](failures == 39, "one of 39 negative fixtures survived")
print("OK: validator green fixtures passed; 39/39 negative mutations rejected")
