...
validator["require"](
    all(os.path.lexists(path) for path in (RUN_OUTPUT, RUN_TARGET)),
    "completed nonzero process lost its artifacts",
)
...
validator["require"](failures == 34, "one of 34 negative fixtures survived")
print("OK: validator green fixtures passed; 34/34 negative mutations rejected")
