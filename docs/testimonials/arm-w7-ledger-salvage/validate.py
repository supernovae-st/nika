...
TESTED_COMMIT = "31c821f1df998901d5cec71553ddacb0a44dc87b"
TESTED_TREE = "bb7f629da770435208edd8e9c6a48cf24cad873b"
RUN_ID = "arm-w7-22d39cf9-45c3-4f29-a12d-692020b4031e"
RUN_WORKTREE = "/tmp/nika-pr1079-mutants-31c821f1"
...
def verify_final(repo: pathlib.Path, final_commit: str, raw_output: pathlib.Path | None) -> dict[str, Any]:
    ...
    require_run_after_receipt(receipt_time, manifest["run"]["start_time"])
...
def self_test() -> None:
    ...
    try:
        ...
        failures += 1
    require(failures == 5, "chronology or run identity mutation survived")
    print("OK: validator green fixture passed; 5/5 negative mutations rejected")
