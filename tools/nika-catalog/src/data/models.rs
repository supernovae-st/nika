...
pub static ALL_PRICING: &[ModelPricing] = &[
    // ── Anthropic ───────────────────────────────────────────────
    ModelPricing::new("Anthropic", "claude-3-haiku", 0.25, 1.25),
    ModelPricing::new("Anthropic", "opus-4", 15.0, 75.0),
    ModelPricing::new("Anthropic", "sonnet-4", 3.0, 15.0),
    ModelPricing::new("Anthropic", "haiku-4", 0.8, 4.0),
    ModelPricing::new("Anthropic", "claude-3-5-sonnet", 3.0, 15.0),
    ModelPricing::new("Anthropic", "claude-3-5-haiku", 0.8, 4.0),
    ModelPricing::new("Anthropic", "claude-3-opus", 15.0, 75.0),
    ModelPricing::new("Anthropic", "claude-3-sonnet", 3.0, 15.0),
    // ── OpenAI (ordering critical for contains fallback) ────────
    ModelPricing::new("OpenAI", "gpt-4o-mini", 0.15, 0.6),
    ModelPricing::new("OpenAI", "gpt-4o", 2.5, 10.0),
    ModelPricing::new("OpenAI", "gpt-4.1-nano", 0.1, 0.4),
    ModelPricing::new("OpenAI", "gpt-4.1-mini", 0.4, 1.6),
    ModelPricing::new("OpenAI", "gpt-4.1", 2.0, 8.0),
    ModelPricing::new("OpenAI", "gpt-3.5-turbo", 0.5, 1.5),
    ModelPricing::new("OpenAI", "gpt-4-turbo", 10.0, 30.0),
    ModelPricing::new("OpenAI", "gpt-4", 30.0, 60.0),
    ModelPricing::new("OpenAI", "gpt-5.4-nano", 0.10, 0.40),
    ModelPricing::new("OpenAI", "gpt-5.4-mini", 0.40, 1.60),
    ModelPricing::new("OpenAI", "gpt-5.4", 2.00, 8.00),
    ModelPricing::new("OpenAI", "gpt-5.2-pro", 21.0, 168.0),
    ModelPricing::new("OpenAI", "gpt-5.2", 1.75, 14.0),
    ModelPricing::new("OpenAI", "gpt-5", 1.75, 14.0),
    ModelPricing::new("OpenAI", "o1-mini", 3.0, 12.0),
    ModelPricing::new("OpenAI", "o1", 15.0, 60.0),
    ModelPricing::new("OpenAI", "o3-mini", 1.1, 4.4),
    ModelPricing::new("OpenAI", "o4-mini", 1.1, 4.4),
    ModelPricing::new("OpenAI", "o3", 2.0, 8.0),
    // o4-mini BEFORE o4 (contains "o4" substring)
    ModelPricing::new("OpenAI", "o4", 2.0, 8.0),
    // ── Mistral ─────────────────────────────────────────────────
    ModelPricing::new("Mistral", "mistral-large", 2.0, 6.0),
    ModelPricing::new("Mistral", "mistral-medium", 2.7, 8.1),
    ModelPricing::new("Mistral", "mistral-small", 0.2, 0.6),
    ModelPricing::new("Mistral", "codestral", 0.3, 0.9),
    ModelPricing::new("Mistral", "ministral-8b", 0.1, 0.1),
    ModelPricing::new("Mistral", "ministral-3b", 0.04, 0.04),
    ModelPricing::new("Mistral", "pixtral-large", 2.0, 6.0),
    ModelPricing::new("Mistral", "pixtral-12b", 0.15, 0.15),
    // ── Groq ────────────────────────────────────────────────────
    ModelPricing::new("Groq", "llama-3.3-70b-specdec", 0.59, 0.99),
    ModelPricing::new("Groq", "llama-3.3-70b", 0.59, 0.79),
    ModelPricing::new("Groq", "llama-3.1-70b", 0.59, 0.79),
    ModelPricing::new("Groq", "llama-3.1-8b", 0.05, 0.08),
    ModelPricing::new("Groq", "llama3-70b", 0.59, 0.79),
    ModelPricing::new("Groq", "llama3-8b", 0.05, 0.08),
    ModelPricing::new("Groq", "mixtral-8x7b", 0.24, 0.24),
    ModelPricing::new("Groq", "gemma2-9b", 0.20, 0.20),
    // ── DeepSeek ────────────────────────────────────────────────
    ModelPricing::new("DeepSeek", "deepseek-chat", 0.14, 0.28),
    ModelPricing::new("DeepSeek", "deepseek-reasoner", 0.55, 2.19),
    ModelPricing::new("DeepSeek", "deepseek-coder", 0.14, 0.28),
    // ── Gemini ──────────────────────────────────────────────────
    ModelPricing::new("Gemini", "gemini-2.5-flash", 0.15, 0.6),
    ModelPricing::new("Gemini", "gemini-2.5-pro", 1.25, 10.0),
    ModelPricing::new("Gemini", "gemini-2.0-flash-exp", 0.0, 0.0),
    ModelPricing::new("Gemini", "gemini-2.0-flash-thinking", 0.0, 0.0),
    ModelPricing::new("Gemini", "gemini-2.0-flash", 0.1, 0.4),
    ModelPricing::new("Gemini", "gemini-1.5-flash-8b", 0.0375, 0.15),
    ModelPricing::new("Gemini", "gemini-1.5-flash", 0.075, 0.3),
    ModelPricing::new("Gemini", "gemini-1.5-pro", 1.25, 5.0),
    ModelPricing::new("Gemini", "gemini-pro", 0.5, 1.5),
    // ── xAI ─────────────────────────────────────────────────────
    ModelPricing::new("xAI", "grok-4", 3.0, 15.0),
    ModelPricing::new("xAI", "grok-3-mini-fast", 0.1, 0.4),
    ModelPricing::new("xAI", "grok-3-mini", 0.3, 0.5),
    ModelPricing::new("xAI", "grok-3-fast", 0.6, 4.0),
    ModelPricing::new("xAI", "grok-3", 3.0, 15.0),
    ModelPricing::new("xAI", "grok-2", 2.0, 10.0),
];
