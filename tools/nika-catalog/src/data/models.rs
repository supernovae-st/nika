...
pub static ALL_PRICING: &[ModelPricing] = &[
    ...
    ModelPricing::new("Anthropic", "claude-3-5-sonnet", 3.0, 15.0, None, None, None),
    ...
    // ── Groq ────────────────────────────────────────────────────
    ModelPricing::new("Groq", "llama-3.3-70b-specdec", 0.59, 0.99, None, None, None),
    ...
    ModelPricing::new("DeepSeek", "deepseek-reasoner", 0.55, 2.19, None, None, None),
    ...
    ModelPricing::new("Gemini", "gemini-2.0-flash-thinking", 0.0, 0.0, None, None, None),
    ModelPricing::new("Gemini", "gemini-2.0-flash", 0.1, 0.4, None, None, None),
    ModelPricing::new("Gemini", "gemini-1.5-flash-8b", 0.0375, 0.15, None, None, None),
