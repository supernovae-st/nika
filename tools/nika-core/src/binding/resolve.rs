...
#[cfg(all(test, feature = "mock-bindings"))]
mod tests {
    use super::*;
    use crate::binding::mock::MockBindingStore;
    use crate::binding::transform::TransformExpr;
    use crate::binding::types::BindingPath;
    use crate::binding::{
        BindingEntry, BindingResolveError, BindingSpec, BindingSource, BindingType, PathSegment,
        WithEntry, WithSpec,
    };
    ...
    fn with_entry_missing_env_with_pipe_default() {
        ...
        let entry = WithEntry {
            ...
            lazy: false,
            transform: Some(
                crate::binding::TransformExpr::parse("default(\"fallback\")").unwrap(),
            ),
        };
