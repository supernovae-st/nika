...
pub static LEVELS: &[Level] = &[
    Level {
        ...
        slug: "jailbreak",
        name: "Jailbreak",
        description: "Break free from manual commands. Learn exec: and basic workflows.",
        exercise_count: 5,
        boss: false,
    },
    Level {
        ...
        slug: "hot-wire",
        name: "Hot Wire",
        description: "Hot-wire the network. Master fetch: for HTTP requests and APIs.",
        exercise_count: 4,
        boss: false,
    },
    Level {
    ...
    Level {
        ...
        slug: "root-access",
        name: "Root Access",
        description: "Unlock the LLM. First infer: prompts with provider setup.",
        exercise_count: 3,
        boss: false,
    },
    Level {
        ...
        slug: "shapeshifter",
        name: "Shapeshifter",
        description: "Transform data with with: bindings and pipe transforms.",
        exercise_count: 3,
        boss: false,
    },
    Level {
