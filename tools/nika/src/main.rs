...
// Input parsing helpers live in nika-cli::inputs (extracted in Phase 15 commit 1).
use cli::inputs::{load_input_file, parse_cli_inputs, parse_input_value, simple_input_resolve};

// Workflow discovery + task filtering live in nika-cli (extracted in Phase 15 commit 2).
use cli::discover::{
    count_nika_workflows, is_nika_workflow, resolve_or_discover_workflow, resolve_workflow_path,
};
use cli::task_filter::{filter_tasks_for_target, filter_tasks_from};
