...
pub(in crate::tui::views::chat) struct SelectionContext {
...
impl ChatView {
    ...
    pub(in crate::tui::views::chat) fn build_message_items<'a>(
        &self,
        theme: &Theme,
        colors: &RenderColors,
        content_width: usize,
...
fn render_execution<'a>(
    exec: &crate::tui::views::chat::ExecutionResult,
    theme: &Theme,
    lines: &mut Vec<ListItem<'a>>,
) {
