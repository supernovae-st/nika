...
use crate::tui::views::chat::{InlineContent, SEPARATOR_52};
...
pub(in crate::tui::views::chat) fn render_inline_content<'a>(
...
fn render_mcp_call<'a>(
    data: &crate::tui::widgets::McpCallData,
    colors: &RenderColors,
    items: &mut Vec<ListItem<'a>>,
) {
...
fn render_infer_stream<'a>(
    data: &crate::tui::widgets::InferStreamData,
    colors: &RenderColors,
    items: &mut Vec<ListItem<'a>>,
) {
