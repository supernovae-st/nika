...
use crate::ast::{parse_workflow, TaskAction, Workflow};
...
impl HomeView {
    ...
    pub(crate) fn task_verb_color(task: &crate::ast::Task) -> VerbColor {
        match &task.action {
    ...
    pub(crate) fn extract_prompt_preview(task: &crate::ast::Task) -> Option<String> {
        match &task.action {
